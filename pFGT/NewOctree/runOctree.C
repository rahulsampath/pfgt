...
PetscLogEvent expandEvent;
PetscLogEvent directEvent;
...
int main(int argc, char** argv) {
  ...
  PetscLogEventRegister("Expand", fgtCookie, &expandEvent);
  PetscLogEventRegister("Direct", fgtCookie, &directEvent);
