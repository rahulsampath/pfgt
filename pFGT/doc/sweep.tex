...
\begin{enumerate}    
  ...
  \item The local expansion $v_k$ of the box $B(i+1, j+1)$ can be written in terms for the
...
%
\beq |\mathcal{I}[B_1]| + \sum_{j=1}^{|B|-1} |\mathcal{I}(B_j)\cup\mathcal{I}(B_{j+1}) - \mathcal{I}(B_j)\cap\mathcal{I}(B_{j+1})| \label{eqn:OT}\eeq
%
is minimized.}
\end{prob}
