...
%
\item For uniform tensor-product grids, we incorporate the accelerations introduced in \cite{fggt}. Thereby, the complexity constants in our scheme scale linearly with  the number of dimensions as opposed to exponential growth. We present a parallel version of FGT for uniform distributions. We demonstrate the scalability of our algorithm using  upto 120 billion points. To our knowledge, the Gauss transform of such a large number of points has not been computed before.
%
