...
\item We extend our algorithms to work with nonuniform distributions by using the linear octree data structure. This was motivated by the tree-splitting scheme used in \cite{veerapaneni08} for computing continuous Gauss transforms. The cost of the  \newpage 
original FGT algorithm increases as $\delta$ decreases; in contrast, our octree based algorithm scales well in all ranges of the parameters.
