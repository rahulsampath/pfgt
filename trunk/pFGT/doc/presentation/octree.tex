...
\item Communicate expansions to owners of respective FGT boxes
...
\only<2>{
\begin{enumerate}[(A)]
\item CPUs containing {\color{blue}{Direct}} targets form a list of required FGT boxes
\item Get plane wave expansions for these FGT boxes from their owners
