...
\begin{tikzpicture}[scale=0.75]
				...
				\fill[blue!70] (6,0) rectangle (8,2);
 				...
 				\fill[green!65!black] (0,0) rectangle (2,2); 				
 				\fill[green!65!black] (2,2) rectangle (4,8);
 				\fill[green!65!black] (4,0) rectangle (6,4);
 				\fill[green!65!black] (6,2) rectangle (8,4);
 				\fill[green!65!black] (4,6) rectangle (8,8);
        ...
        \draw[fill=red] (0.5, 0.5) circle (0.125);
	  		...
	  		\draw[fill=red] (5, 5) circle (0.125);
	  		\draw[fill=red] (1, 6.25) circle (0.125);
