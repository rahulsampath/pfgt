...
\end{tikzpicture}
\caption{\label{f:directExpand} The direct octants are marked in and the expand octants are marked in .}  
\end{figure}
...
\item[\textbf{D2L}] For each source, $y$, within some direct leaf, find all FGT boxes, $B$, such that $\mathcal{I}[y]$ intersects $B$ and
modify the local expansion of $B$
